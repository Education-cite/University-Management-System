...
import com.university.dao.StudentFeedbackRepo;
...
public class AuthinticationFieldsController {
	...
	public String home(Model model, @RequestParam(value = "page", defaultValue = "0") int page) {
		model.addAttribute("title", "Home - University");
	...
	public String about(Model model) {
		...
		model.addAttribute("title", "about - University");
		return "Dashboard/about";
	}

	@RequestMapping("/signup")
	public String signUp(Model model) {
		model.addAttribute("title", "Register - University");
